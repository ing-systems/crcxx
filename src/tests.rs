...
fn test_rand_crc8() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc8::crc8_update_lut_256(0, &data, &lut[0]);
...
fn test_rand_crc8_reflected() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc8::crc8_update_ref_lut_256(0, &data, &lut[0]);
...
fn test_rand_crc16() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc16::crc16_update_lut_256(0, &data, &lut[0]);
...
fn test_rand_crc16_reflected() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc16::crc16_update_ref_lut_256(0, &data, &lut[0]);
...
fn test_rand_crc32() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc32::crc32_update_lut_256(0, &data, &lut[0]) ^ 0xFFFFFFFF;
...
fn test_rand_crc32_reflected() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc32::crc32_update_ref_lut_256(0, &data, &lut[0]) ^ 0xFFFF_FFFF;
...
fn test_rand_crc64() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc64::crc64_update_lut_256(0, &data, &lut[0]);
...
fn test_rand_crc64_reflected() {
    ...
    for _ in 0..ITERATIONS {
        ...
        let crc_trusted = crc64::crc64_update_ref_lut_256(0, &data, &lut[0]);

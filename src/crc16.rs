...
pub fn crc16_update(mut crc: u16, mut bytes: &[u8], lut: &[[u16; 256]]) -> u16 {
    ...
    crc16_update_lut_256(crc, bytes, &lut[0])
}

pub fn crc16_update_ref(mut crc: u16, mut bytes: &[u8], lut: &[[u16; 256]]) -> u16 {
    ...
    crc16_update_ref_lut_256(crc, bytes, &lut[0])
}

#[inline]
fn update_slice_by_4<'a, const REFLECT: bool>(
    mut crc: u16, mut bytes: &'a [u8], lut: &[[u16; 256]],
) -> (u16, &'a [u8]) {
    const STEP: usize = 4;
